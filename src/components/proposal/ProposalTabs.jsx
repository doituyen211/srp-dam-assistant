...
/**
 * ProposalTabs - 5-tab container for proposal detail
 * Tabs: Overview | Sections | AI Evaluation | Supervisor Matching | History
 */
export function ProposalTabs({ activeTab, onTabChange, children }) {
  const tabs = [
    ...
    { id: "ai_evaluation", label: "AI Evaluation", icon: (
    ...
    { id: "supervisor_matching", label: "Supervisor Matching", icon: (
    ...
    { id: "history", label: "History", icon: (
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 6v6l4 2M12 3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    )},
  ];
