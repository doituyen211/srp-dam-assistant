      ...
      <div className="flex h-full items-center justify-between px-4 sm:px-6 md:px-8">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <h1 className="text-sm font-semibold text-ink">SRP D&amp;M Assistant</h1>
            <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted">Research Proposal Platform</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden text-right sm:block">
            <p className="max-w-[180px] truncate text-sm font-medium text-ink">{user.name}</p>
            <p className="max-w-[180px] truncate text-xs text-body-muted">{user.email}</p>
          </div>
